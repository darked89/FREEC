...
/*************************************************************************
   ...
   -- ALGLIB --
     Copyright 30.08.2008 by Bochkanov Sergey
*************************************************************************/
void lrpack(const ap::real_1d_array& v,
            int                      nvars,
            linearmodel            & lm);
...
*************************************************************************/
void lrcopy(const linearmodel& lm1,
            linearmodel      & lm2);
...
/*************************************************************************
   ...
   -- ALGLIB --
     Copyright 15.03.2009 by Bochkanov Sergey
*************************************************************************/
void lrserialize(const linearmodel& lm,
                 ap::real_1d_array& ra,
                 int              & rlen);
...
/*************************************************************************
   ...
   -- ALGLIB --
     Copyright 15.03.2009 by Bochkanov Sergey
*************************************************************************/
void lrunserialize(const ap::real_1d_array& ra,
                   linearmodel            & lm);
