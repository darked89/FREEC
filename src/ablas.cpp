...
static void ablasinternalsplitlength(int  n,
                                     int  nb,
                                     int& n1,
                                     int& n2);
                      ...
                      int                         jb)
{
  ...
  if ((m <= 2 * ablascomplexblocksize(a)) && (n <= 2 * ablascomplexblocksize(a)))
  {
    ...
    for (i = 0; i <= m - 1; i++)
    {
      ap::vmove(&b(ib, jb + i), b.getstride(), &a(ia + i, ja), 1, "N",
                ap::vlen(ib, ib + n - 1));
    }
  }
  else
                      ...
                      int                      jb)
{
  ...
  if ((m <= 2 * ablasblocksize(a)) && (n <= 2 * ablasblocksize(a)))
  {
    ...
    for (i = 0; i <= m - 1; i++)
    {
      ap::vmove(&b(ib, jb + i), b.getstride(), &a(ia + i, ja), 1,
                ap::vlen(ib, ib + n - 1));
    }
  }
  else
                 ...
                 int                         jb)
{
  ...
  for (i = 0; i <= m - 1; i++)
  {
    ap::vmove(&b(ib + i, jb), 1, &a(ia + i, ja), 1, "N",
              ap::vlen(jb, jb + n - 1));
  }
}
               ...
               int                iy)
{
  ...
  if (opa == 0)
  {
    ...
    {
      v =
        ap::vdotproduct(&a(ia + i, ja), 1, &x(ix), 1, ap::vlen(ja, ja + n - 1));
      y(iy + i) = v;
    }
    return;
  }
                 ...
                 bool                        isupper)
{
  ...
  if (k >= n)
  {
    ...
    if (optypea == 0)
    {
      cmatrixsyrk(n, s1, alpha, a, ia, ja,      optypea, beta, c, ic, jc,
                  isupper);
                 ...
                 bool                     isupper)
{
  ...
  if (k >= n)
  {
    ...
    if (optypea == 0)
    {
      rmatrixsyrk(n, s1, alpha, a, ia, ja,      optypea, beta, c, ic, jc,
                  isupper);
    ...
    if (optype == 0)
    {
      ...
      for (i = 0; i <= m - 1; i++)
      {
        for (j = 0; j <= n - 1; j++)
        {
          ...
          {
            vc = x(i2 + i, j2 + j);
            ap::vsub(&x(i2 + i, j2 + j + 1),
                     1,
                     &a(i1 + j, j1 + j + 1),
                     1,
                     "N",
                     ap::vlen(j2 + j + 1, j2 + n - 1),
                     vc);
          }
        }
      }
    ...
    if (optype == 0)
    {
      ...
      for (i = 0; i <= m - 1; i++)
      {
        for (j = n - 1; j >= 0; j--)
        {
          ...
          {
            vc = x(i2 + i, j2 + j);
            ap::vsub(&x(i2 + i, j2), 1, &a(i1 + j, j1), 1, "N",
                     ap::vlen(j2, j2 + j - 1), vc);
          }
        }
      }
      return;
  ...
  if (isupper)
  {
    ...
    if (optype == 0)
    {
      ...
      for (i = m - 1; i >= 0; i--)
      {
        ...
        {
          vc = a(i1 + i, j1 + j);
          ap::vsub(&x(i2 + i, j2), 1, &x(i2 + j, j2), 1, "N",
                   ap::vlen(j2, j2 + n - 1), vc);
        }
    ...
    if (optype == 1)
    {
      ...
      for (i = 0; i <= m - 1; i++)
      {
        ...
        {
          vc = a(i1 + i, j1 + j);
          ap::vsub(&x(i2 + j, j2), 1, &x(i2 + i, j2), 1, "N",
                   ap::vlen(j2, j2 + n - 1), vc);
        }
      }
      return;
    ...
    if (optype == 1)
    {
      ...
      for (i = 0; i <= m - 1; i++)
      {
        for (j = n - 1; j >= 0; j--)
        {
          ...
          if (j < n - 1)
          {
            vr = ap::vdotproduct(&x(i2 + i, j2 + j + 1),
                                 1,
                                 &a(i1 + j, j1 + j + 1),
                                 1,
                                 ap::vlen(j2 + j + 1, j2 + n - 1));
    ...
    if (optype == 1)
    {
      ...
      for (i = 0; i <= m - 1; i++)
      {
        for (j = 0; j <= n - 1; j++)
        {
          ...
          {
            vr =
              ap::vdotproduct(&x(i2 + i, j2), 1, &a(i1 + j, j1), 1,
                              ap::vlen(j2, j2 + j - 1));
          }
  ...
  else
  {
    ...
    for (i = 0; i <= k - 1; i++)
    {
      for (j = 0; j <= n - 1; j++)
      {
        ...
        ap::vadd(&c(ic + j, jc + j1), 1, &a(ia + i, ja + j1), 1, "N",
                 ap::vlen(jc + j1, jc + j2), v);
      }
    }
    return;
  }
  ...
  if (optypea == 0)
  {
    ...
    for (i = 0; i <= n - 1; i++)
    {
      ...
      for (j = j1; j <= j2; j++)
      {
        ...
        {
          v =
            ap::vdotproduct(&a(ia + i, ja), 1, &a(ia + j, ja), 1,
                            ap::vlen(ja, ja + k - 1));
        }
        else
        {
  ...
  else
  {
    ...
    for (i = 0; i <= k - 1; i++)
    {
      for (j = 0; j <= n - 1; j++)
      {
        ...
        v = alpha * a(ia + i, ja + j);
        ap::vadd(&c(ic + j, jc + j1), 1, &a(ia + i, ja + j1), 1,
                 ap::vlen(jc + j1, jc + j2), v);
      }
    }
    return;
  ...
  if ((optypea == 0) && (optypeb == 0))
  {
    ...
    for (i = 0; i <= m - 1; i++)
    {
      ...
      if (alpha != 0)
      {
        ...
        {
          v = alpha * a(ia + i, ja + j);
          ap::vadd(&c(ic + i, jc), 1, &b(ib + j, jb), 1, "N",
                   ap::vlen(jc, jc + n - 1), v);
        }
      }
    }
  ...
  if ((optypea == 0) && (optypeb != 0))
  {
    ...
    for (i = 0; i <= m - 1; i++)
    {
      for (j = 0; j <= n - 1; j++)
      {
        ...
        {
          v =
            ap::vdotproduct(&a(ia + i, ja), 1, &b(ib + j, jb), 1,
                            ap::vlen(ja, ja + k - 1));
        }
