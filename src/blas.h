...
double vectornorm2(const ap::real_1d_array& x,
                   int                      i1,
                   int                      i2);


int vectoridxabsmax(const ap::real_1d_array& x,
                    int                      i1,
                    int                      i2);


int columnidxabsmax(const ap::real_2d_array& x,
                    int                      i1,
                    int                      i2,
                    int                      j);


int rowidxabsmax(const ap::real_2d_array& x,
                 int                      j1,
                 int                      j2,
                 int                      i);
