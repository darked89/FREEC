...
/*************************************************************************
   ...
   -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
void calculateadev(const ap::real_1d_array& x,
                   int                      n,
                   double                 & adev);
...
/*************************************************************************
   ...
   -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
void calculatemedian(ap::real_1d_array x,
                     int               n,
                     double          & median);
...
*************************************************************************/
void calculatepercentile(ap::real_1d_array x,
                         int               n,
                         double            p,
                         double          & v);


#endif // ifndef _descriptivestatistics_h
