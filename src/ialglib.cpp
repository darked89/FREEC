...
static void* alglib_align(void *ptr, size_t alignment)
{
  ...
  if ((result - (char *)0) % alignment !=
      0) result += alignment - (result - (char *)0) % alignment;
  return result;
}
...
********************************************************************/
void ialglib::mv_32(const double *a,
                    const double *x,
                    double       *y,
                    int           stride,
                    double        alpha,
...
/********************************************************************
   ...
   It may work with unaligned data.
********************************************************************/
void ialglib::mv_complex_generic(int           m,
                                 int           n,
                                 const double *a,
                                 const double *x,
                                 ap::complex  *cy,
...
********************************************************************/
void ialglib::vcopy_complex(int                n,
                            const ap::complex *a,
                            int                stridea,
                            double            *b,
                            int                strideb,
...
* 1 - transposition
********************************************************************/
void ialglib::mcopyunblock(int           m,
                           int           n,
                           const double *a,
                           int           op,
                           double       *b,
...
********************************************************************/
void ialglib::mcopyblock_complex(int                m,
                                 int                n,
                                 const ap::complex *a,
                                 int                op,
                                 int                stride,
...
* 3 - conjugate, but no  transposition
********************************************************************/
void ialglib::mcopyunblock_complex(int           m,
                                   int           n,
                                   const double *a,
                                   int           op,
                                   ap::complex  *b,
                              ...
                              int                      jc)
{
  ...
  // copy b
  //
  if (optypeb == 0) mcopyblock(k, n, &_b(ib, jb), 1, _b.getstride(), b);
  else mcopyblock(n, k, &_b(ib, jb), 0, _b.getstride(), b);
                              ...
                              int                         jc)
{
  ...
  if (optypeb == 0) mcopyblock_complex(brows,
                                       bcols,
                                       &_b(ib, jb),
                                       1,
                                       _b.getstride(),
  ...
  if (optypeb == 1) mcopyblock_complex(brows,
                                       bcols,
                                       &_b(ib, jb),
                                       0,
                                       _b.getstride(),
  ...
  if (optypeb == 2) mcopyblock_complex(brows,
                                       bcols,
                                       &_b(ib, jb),
                                       3,
                                       _b.getstride(),
  ...
  for (i = 0; i < m; i++)
  {
    ...
    if (beta == 0) vzero_complex(n, crow, 1);
...
bool ialglib::_i_cmatrixrighttrsmf(int                         m,
                                   ...
                                   int                         j2)
{
  if ((m > alglib_c_block) || (n > alglib_c_block)) return false;
  ...
  double *const abuf = (double *const)alglib_align(__abuf,
                                                   alglib_simd_alignment);
  double *const xbuf = (double *const)alglib_align(__xbuf,
                                                   alglib_simd_alignment);
  double *const tmpbuf = (double *const)alglib_align(__tmpbuf,
                                                     alglib_simd_alignment);
...
bool ialglib::_i_rmatrixrighttrsmf(int                      m,
                                   ...
                                   int                      j2)
{
  if ((m > alglib_r_block) || (n > alglib_r_block)) return false;
  ...
  if (isunit)
    for (i = 0, pdiag = abuf; i < n;
         i++, pdiag += alglib_r_block + 1) *pdiag = 1.0;
  ...
  else
  {
         ...
         i--, pdiag -= alglib_r_block + 1)
    {
      ...
      mv(m, n - 1 - i, xbuf + i + 1, tmpbuf, xbuf + i, alglib_r_block, alpha,
         beta);
    }
    mcopyunblock(m, n, xbuf, 0, &x(i2, j2), x.getstride());
  }
                                  ...
                                  int                      j2)
{
  ...
  if (uppera)
  {
         ...
         i--, pdiag -= alglib_r_block + 1)
    {
      ...
      mv(n, m - 1 - i, xbuf + i + 1, tmpbuf, xbuf + i, alglib_r_block, alpha,
         beta);
    }
...
bool ialglib::_i_cmatrixsyrkf(int                         n,
                              ...
                              bool                        isupper)
{
  if ((n > alglib_c_block) || (k > alglib_c_block)) return false;
  ...
  double *const abuf = (double *const)alglib_align(__abuf,
                                                   alglib_simd_alignment);
  double *const cbuf = (double *const)alglib_align(__cbuf,
                                                   alglib_simd_alignment);
  double *const tmpbuf = (double *const)alglib_align(__tmpbuf,
                                                     alglib_simd_alignment);
  ...
  {
    if (optypea ==
        0) mcopyblock_complex(n, k, &a(ia, ja), 3, a.getstride(), abuf);
    else mcopyblock_complex(k, n, &a(ia, ja), 1, a.getstride(), abuf);
  }
  ...
  if (beta == 0)
  {
    for (i = 0, crow = cbuf; i < n; i++, crow += 2 * alglib_c_block)
      if (isupper) vzero(2 * (n - i), crow + 2 * i, 1);
      else vzero(2 * (i + 1), crow, 1);
  }
...
bool ialglib::_i_rmatrixsyrkf(int                      n,
                              ...
                              bool                     isupper)
{
  if ((n > alglib_r_block) || (k > alglib_r_block)) return false;
  ...
  double *const abuf =
    (double *const)alglib_align(__abuf,  alglib_simd_alignment);
  double *const cbuf =
    (double *const)alglib_align(__cbuf,  alglib_simd_alignment);
  ...
  if (k > 0)
  {
    if (optypea == 0) mcopyblock(n, k, &a(ia, ja), 0, a.getstride(), abuf);
    else mcopyblock(k, n, &a(ia, ja), 1, a.getstride(), abuf);
  }
  ...
  if (beta == 0)
  {
    for (i = 0, crow = cbuf; i < n; i++, crow += alglib_r_block)
      if (isupper) vzero(n - i, crow + i, 1);
      else vzero(i + 1, crow, 1);
  }
...
/*void ap::mv_32_sse2(const double *a, const double *x, double *y, double alpha,
   double beta)
   {
    int j;
    const double *pa, *pb;
...
/*void ap::mv_complex_sse2(int m, int n, const double *a, const double *x,
   ap::complex *y, ap::complex alpha, ap::complex beta)
   {
    int i, j, n2;
    const double *pa, *parow, *pb;
    double v0, v1, v2, v3;
    ...
    for(i=0; i<m; i++)
    {
        __m128d v_ac_bd, v_ad_bc, v00, v01, v10, v11, mma0, mma1, mmb0, mmb1,
           mmalpha, mmbeta;
        pa = parow;
