...
#else // ifndef ALGLIB_INTERCEPTS_ABLAS
  return ialglib::_i_cmatrixrank1f(m, n, a, ia, ja, u, iu, v, iv);

#endif // ifndef ALGLIB_INTERCEPTS_ABLAS
}
...
#else // ifndef ALGLIB_INTERCEPTS_ABLAS
  return ialglib::_i_cmatrixrighttrsmf(m,
                                       n,
                                       a,
                                       i1,
                                       j1,
...
#else // ifndef ALGLIB_INTERCEPTS_ABLAS
  return ialglib::_i_cmatrixlefttrsmf(m,
                                      n,
                                      a,
                                      i1,
                                      j1,
...
#else // ifndef ALGLIB_INTERCEPTS_ABLAS
  return ialglib::_i_rmatrixrighttrsmf(m,
                                       n,
                                       a,
                                       i1,
                                       j1,
...
#else // ifndef ALGLIB_INTERCEPTS_ABLAS
  return ialglib::_i_rmatrixlefttrsmf(m,
                                      n,
                                      a,
                                      i1,
                                      j1,
...
#else // ifndef ALGLIB_INTERCEPTS_ABLAS
  return ialglib::_i_cmatrixsyrkf(n,
                                  k,
                                  alpha,
                                  a,
                                  ia,
...
#else // ifndef ALGLIB_INTERCEPTS_ABLAS
  return ialglib::_i_rmatrixsyrkf(n,
                                  k,
                                  alpha,
                                  a,
                                  ia,
...
#else // ifndef ALGLIB_INTERCEPTS_ABLAS
  return ialglib::_i_rmatrixgemmf(m,
                                  n,
                                  k,
                                  alpha,
                                  a,
...
#else // ifndef ALGLIB_INTERCEPTS_ABLAS
  return ialglib::_i_cmatrixgemmf(m,
                                  n,
                                  k,
                                  alpha,
                                  a,
