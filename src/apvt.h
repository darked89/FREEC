...
public:
  ...
  raw_vector(T *Data, int Length, int Step) : const_raw_vector<T>(Data,
                                                                  Length,
                                                                  Step) {}
...
T vdotproduct(const_raw_vector<T>v1, const_raw_vector<T>v2)
{
  ...
  else
  {
    ...
    // general
    //
    int offset11 = v1.GetStep(), offset12 = 2 * offset11, offset13 = 3 * offset11,
        offset14 = 4 * offset11;
    ...
    for (i = 0; i < imax; i++)
    {
      r += (*p1) * (*p2) + p1[offset11] * p2[offset21] + p1[offset12] *
           p2[offset22] + p1[offset13] * p2[offset23];
      p1 += offset14;
      p2 += offset24;
    }
