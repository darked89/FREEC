...
void vcopy_complex(int           n,
                   ...
                   int           strideb,
                   char         *conj);
void mcopyblock(int           m,
                int           n,
                const double *a,
                int           op,
                int           stride,
                double       *b);
void mcopyunblock(int           m,
                  int           n,
                  const double *a,
                  int           op,
                  double       *b,
                  int           stride);
void mcopyblock_complex(int                m,
                        int                n,
                        const ap::complex *a,
                        int                op,
                        int                stride,
                        double            *b);
void mcopyunblock_complex(int           m,
                          int           n,
                          const double *a,
                          int           op,
                          ap::complex  *b,
